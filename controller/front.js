...
exports.orders = function(req, res){
    var frontEmail = req.user.local.email;
    OrderModel.find({placeName:frontEmail.substring(0, frontEmail.indexOf("@"))}),PlaceModel.find({name:frontEmail.substring(0, frontEmail.indexOf("@"))}).exec(function(err, data){
        res.render('front/order.ejs', {orders:data,places:data})
